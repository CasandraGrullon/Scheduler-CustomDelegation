...
class CreateEventController: UIViewController {
  ...
  // private for setting ==> cannot write to it outside of this view controller
  // public for getting ==> can read it/ use it outside of this view controller
  ...
  private func updateUI() {
    if let event = event { //comes from didSelectRow from last vc
      self.event = event
